...
conn.SetEmoji(0, 0x00)             // key 0 shows the placeholder box
...
`0x00` (the placeholder box), blink off, a neutral color — instead of
whatever the emoji ID field happens to hold; see the Emoji ID table in
